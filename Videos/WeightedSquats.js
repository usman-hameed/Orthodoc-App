...
const WeightedSquats = ({navigation}) => {
  return (
    <ScrollView>
...
<View style={styles.Utext}>
          ...
          <View style={styles.Vtext}>
            ...
            >Weightlifting is actually healthy for those diagnosed with osteoarthritis, because strong muscles support the joints. Weightlifting can also ease joint pain and stiffness, boost bone strength, and maintain a healthy weight</Text>
            </View>
