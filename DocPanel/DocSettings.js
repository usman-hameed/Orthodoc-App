...
const myDoc= doc(db, 'doctors',mail);
  ...
  return (
        <View style={styles.container} >
          ...
          <TouchableOpacity onPress={() => navigation.navigate('DocEdit')}> 
          ...
          <Text></Text>
            ...
            <TouchableOpacity style={styles.button} 
                onPress={() => navigation.navigate('DocChangepass')}> 
              <Text
